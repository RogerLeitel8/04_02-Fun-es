...
let emails = [
    {mail:"ratopaçoca", senha:123},
    {mail:"batatapalha", senha:123},
    {mail:"mamaodaindia", senha:123},
];
...
for( let email of emails){
    if(inputEmail.value == email.mail && inputSenha.value == email.senha){
        texto.innerHTML = "Login Aprovado";
        texto.style.color = "blue";
        texto.style.border = "2px blue solid";
        return;
        }
    else{
        texto.innerHTML = "Login Inválido";
        texto.style.color = "red";
        texto.style.border = "2px red dotted";
        }
}
}
botao.onclick = validarLogin;